  ...
  findVehicleToTow(truck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        ...
        let towThis = answers.vehicleToTow;
        if( towThis === truck){
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            ...
            if (currentVehicle.vin === this.selectedVehicleVin && currentVehicle instanceof Truck) {
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            let currentVehicle = this.vehicles[i]; 
            if ( currentVehicle.vin === this.selectedVehicleVin && currentVehicle instanceof Motorbike) {
              currentVehicle.doAWheelie();
            }
          }
